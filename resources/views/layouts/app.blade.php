...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @stack('styles') <!--Directiva para agregar hojas de stilos que no están en todas las vistas-->
        @vite('resources/css/app.css')
        @vite('resources/js/app.js')
        @livewireStyles <!--Agregar estilos de livewire-->
    ...
    <body class="bg-gray-100">
        ...
        <footer class="mt-10 text-center p-5 text-gray-500 font-bold uppercase">
            Henry Ceballos - Todos los derechos reservados {{ now()->year }}
        </footer>

        @livewireScripts <!--Agregar js de livewire-->
    </body>
</html>